...
class Constants {
  ...
  static const String newApiBaseURL = "https://newsapi.org/v2";
  ...
  static Color secondPageContainerGradient1stColor = const Color(0xFF2547AD);
  static Color secondPageContainerGradient2ndColor = const Color(0xFF5B81F1);
  static Color secondPageIcons = const Color(0xFFfafafe);
  ...
  static Color myCyanAccent = Color(0xFF0a617e);
}
